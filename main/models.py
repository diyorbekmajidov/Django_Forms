...
class ArticleSeries(models.Model):
    ...
    author = models.ForeignKey(get_user_model(),default=1, on_delete=models.SET_DEFAULT, max_length=255)
    image = models.ImageField(default='default/1.jpg', upload_to=image_upload_to, max_length=255)
...
class Article(models.Model):
    def image_upload_to(self, instance=None):
        if instance:
            return os.path.join("Article", slugify(self.series.slug), instance)
        return None
